...
class AdminUserHistoryPage extends StatefulWidget {
  final String id;
  const AdminUserHistoryPage({super.key, required this.id});
...
class _AdminUserHistoryPageState extends State<AdminUserHistoryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Geçmiş Sürüşleri"),
      ),
                        ...
                        itemBuilder: (context, index) {
                          if (index == 0) {
                            return const Padding(
                              ...
                              child: ListTile(
                                title: Text("Bekleyen"),
                                subtitle: Text("Bekleyen Sürüşleri"),
                              ),
                            );
                          } else {
                            return pendingRequest != null
                                ...
                                : const ListTile(
                                    title: Text(
                                        "Bekleyen Sürüşü bulunmamaktadır."),
                                  );
                          }
                        }),
                    ListView.builder(
