...
class ThemeColors {
  static const offWhite = Color(0xffF5F4F6);
  static const white = Color(0xffFFFFFF);
  static const grayPrimary = Color(0xff707070);
  static const graySecondary = Color(0xffA7A1AD);
  static const grayTertiary = Color(0xffE7E5E9);
  static const appbarOrange = Color(0xffff500a);
  static const goldYellow = Color(0xffFFD700);
  static const Color lightGrey = Color(0xff928a8a);
  static const Color black = Color(0xff231F21);
  static const Color backGroundColor = Color(0xff97F2AA);
  static const Color silverAsh = Color(0xffDDDBD0);
  static const Color silver = Color(0xffEEEFEF);
  static const Color spaceLight = Color(0xff2b3a67);

  static const Color statusBar = Color(0xFF252261);
